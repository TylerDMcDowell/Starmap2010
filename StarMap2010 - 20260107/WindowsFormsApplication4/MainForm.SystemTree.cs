...
namespace StarMap2010
{
    public partial class MainForm
    {
        ...
        private void EnsureSystemTreeMenu()
        {
            ...
            // Optional but very handy: keyboard shortcuts inside the tree
        ...
        {
            if (_objDao == null || tvSystemObjects == null)
                return;
            ...
            string primaryStarType)
        {
            ...
            if (!childrenByParent.TryGetValue(parentObjectId ?? "", out kids))
                return;
            ...
            for (int i = 0; i < kids.Count; i++)
            {
                ...
                if (!string.IsNullOrEmpty(parentObjectId) &&
                    string.Equals(c.ObjectId, parentObjectId, StringComparison.Ordinal))
                    continue;
